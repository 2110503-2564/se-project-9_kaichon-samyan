...
export default function RatingForm({ hotelId, rating, handleClose }: { hotelId: string, rating : Rating, handleClose: Function }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await editRating(hotelId, score, comment, session.data?.user.token, rating._id);
